  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text('Bilol Abdunazarov', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
        const SizedBox(height: 8),
        const Text('99 438 43 91', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
